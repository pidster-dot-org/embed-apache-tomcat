...
import org.pidster.tomcat.dummy.SlowContainerInitializer;


public class TomcatSlowLoaderTest {

    private static final String TARGET = "http://127.0.0.1:9082/test/slow";
    ...
    public void setupTomcat() throws Exception {
        ...
        Tomcat tomcat = new TomcatFactory(properties).create()
            .newMinimalServer(url.getPort())
                ...
                .addServletContainerInitializer(SlowContainerInitializer.class)
            .build();
